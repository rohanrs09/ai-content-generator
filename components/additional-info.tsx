  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
      <WobbleCard
        ...
        className="" 
      >
        <Link href={'https://github.com/rohanrs09/text-under-image.git'} target="_blank" rel="noopener noreferrer">
      ...
      <Link href={'https://www.linkedin.com/in/rohan-shelke-bba43b22b/'} target="_blank" rel="noopener noreferrer">
